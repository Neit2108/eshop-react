...
import type { Product, ProductFilters, ProductQuery, ProductState } from "@/types/product.types";
...
export const createProduct = createAsyncThunk(
    ...
    async (productData: Omit<Product, 'id' | 'createdAt'>, {rejectWithValue}) => {
        try{
...
const productSlice = createSlice({
  ...
  initialState,
  reducers: {
    setFilters: (state: ProductState, action: PayloadAction<ProductFilters>) => {
...
export const { setFilters, setPage, setPageSize, clearFilters } = productSlice.actions
